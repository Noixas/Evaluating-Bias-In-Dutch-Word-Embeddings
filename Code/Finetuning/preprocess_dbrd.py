...
def create_arg_parser():
    ...
    parser.add_argument("--path", help="Path to the corpus folder.", metavar="path", default="../../Rodrigo-data/Corpus/110kDBRD/")
...
def process_dbrd(raw_data_path, test_or_train):
    processed_data_path = Path("..","..", "Rodrigo-data", "Finetuning", "dbrd")
